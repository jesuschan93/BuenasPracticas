...
namespace AliExpress.Services.Pedido
{
    ...
    /// </summary>
    public class ObtenedorDatosEnvioAereoService : IObtenedorDatosEnvioService
    {
        /// <summary>
        /// 
        /// </summary>
        private readonly IObtenedorDatosEnvio obtenedorDatosEnvio;
        public ObtenedorDatosEnvioAereoService(IObtenedorDatosEnvio _obtenedorDatosEnvio)
        {
        ...
        {
            return EMediosTransporte.Aereo;
        }
    }
}
