...
namespace AliExpress.Services.Paqueteria
{
    ...
    /// 
    /// </summary>
    public class RecuperadorDatosPaqueteriaDHLService : IRecuperadorDatosPaqueteriaService
    {
        /// <summary>
        /// 
        /// </summary>
        private readonly IRecuperadorDatosPaqueteria recuperadorDatosPaqueteria;
        public RecuperadorDatosPaqueteriaDHLService(IRecuperadorDatosPaqueteria _recuperadorDatosPaqueteria)
        {
