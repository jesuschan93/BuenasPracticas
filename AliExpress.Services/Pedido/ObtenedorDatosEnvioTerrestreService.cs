...
namespace AliExpress.Services.Pedido
{
    ...
    /// </summary>
    public class ObtenedorDatosEnvioTerrestreService : IObtenedorDatosEnvioService
    {
        /// <summary>
        /// 
        /// </summary>
        private readonly IObtenedorDatosEnvio obtenedorDatosEnvio;
        public ObtenedorDatosEnvioTerrestreService(IObtenedorDatosEnvio _obtenedorDatosEnvio)
        {
        ...
        {
            return EMediosTransporte.Terrestre;
        }
    }
}
