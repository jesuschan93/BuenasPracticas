...
namespace AliExpress.Services.Paqueteria
{
    ...
    /// 
    /// </summary>
    public class RecuperadorDatosPaqueteriaFedexService : IRecuperadorDatosPaqueteriaService
    {
        /// <summary>
        /// 
        /// </summary>
        private readonly IRecuperadorDatosPaqueteria recuperadorDatosPaqueteria;
        public RecuperadorDatosPaqueteriaFedexService(IRecuperadorDatosPaqueteria _recuperadorDatosPaqueteria)
        {
